...
class DefaultBoxes(object):
    def __init__(self, fig_size, feat_size, steps, scales, aspect_ratios, scale_xy=0.1, scale_wh=0.2):
        ...
        self.scale_xy_ = scale_xy  # scale_xy_=0.1
        self.scale_wh_ = scale_wh  # scale_wh_=0.2
        ...
        self.scales = scales  # 每个特征层上预测的default box的scale default box的大小
        ...
        for idx, sfeat in enumerate(self.feat_size):
            ...
            for w, h in all_sizes:
                # itertools.product()以元组形式生成两个列表数据的笛卡尔内积 repeat参数就是把相同list重复两次传入函数
