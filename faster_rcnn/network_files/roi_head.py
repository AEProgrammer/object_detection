...
class RoIHeads(torch.nn.Module):
    ...
    def select_training_samples(self, proposals, targets):
        ...
        list元素个数为batch_size
        Args:
            proposals: rpn预测的boxes list[[2000,4], [2000,4]], [2000,4],[2000,4]]
                        list列表中每个元素代表一张图片经过rpn生成2000个建议框
            targets: list 每个元素是个dict 代表每张图片的标注信息
        ...
        # 将gt_boxes拼接到proposal后面 把每张图片的gt_boxes拼接到proposals对应元素的后面
